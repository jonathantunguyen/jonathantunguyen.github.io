...
export interface Profile {
  ...
  company: string | null;
  /** One-line tagline; rendered after a blinking caret. */
  tagline: L<string>;
  /**
...
export const profile: Profile = {
  ...
  company: "UpSlide",
  // REVIEW: your voice, not the résumé's — rewrite freely.
  tagline: t(
  ...
  about: t(
    ...
    [
      ...
      "Cela m'a mené de la reconnaissance vocale et de la compréhension de documents chez BNP Paribas Cardif au real-time bidding et à la recommandation chez Voodoo, puis à la vision par ordinateur pour la fraude en magasin chez Carrefour, où j'ai encadré une petite équipe ML. En parallèle, j'ai cofondé JovyanAI, un copilote IA pour la data science : c'est là que je me suis plongé dans les pipelines RAG et les architectures multi-agents.",
  ...
  // REVIEW: all four are drawn from the résumé, but pick the four you'd
  // actually want a recruiter to read first.
  stats: [
